 ...
 */
namespace Bluethinkinc\AdminGrid\Block\Adminhtml\Frontend\Region;
...
class Updater extends \Magento\Config\Block\System\Config\Form\Field
{
    ...
    protected function _getElementHtml(AbstractElement $element)
    {
        ...
        $js = 'require(["prototype", "mage/adminhtml/form"], function(){
               updater = new RegionUpdater("bttraning_defaults_country", "none", "bttraning_defaults_region", %s, "nullify");
               if(updater.lastCountryId) {
                   var tmpRegionId = $("bttraning_defaults_region").value;
                   var tmpCountryId = updater.lastCountryId;
                   updater.lastCountryId=false;
                   updater.update();
                   updater.lastCountryId = tmpCountryId;
                   alert(updater.lastCountryId)
